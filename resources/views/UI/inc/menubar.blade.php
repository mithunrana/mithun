<header id="header" style="border-bottom:3px solid #ff5722;">
            <div class="container main-menu">
                <div class="row align-items-center justify-content-between d-flex">
                    <div id="logo">
                        <a href="{{asset('')}}"><img style="width: 120px;height:40px;" src="{{asset('')}}images/mithun-logo.png" alt="" title="" /></a>
                    </div>
                    <nav id="nav-menu-container">
                        <ul class="nav-menu">
                            ...
                            <li><a href="{{url('about-mithun-rana')}}">About</a></li>
                            <li><a href="{{url('contact-mithun-rana')}}">Contact</a></li>
                        </ul>
