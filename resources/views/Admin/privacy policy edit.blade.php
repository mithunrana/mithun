                ...
                <div class="col-sm-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="{{url('admin/update-privacy-policy',[$PrivacyPolicy->id])}}" method="post">
                                @csrf
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="padding-left: 0px;">
                                            <input type="text"  class="form-control" value="{{$PrivacyPolicy->PrivacyPolicyTitle}}" name="PrivacyPolicyTitle">
                                        </div>
                                    </div>
                                    @if($errors->has('PrivacyPolicyTitle'))
                                        <div class="error" style="color: red">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea type="text" rows="5" class="form-control" id="servicedetails" placeholder="Enter Blog Details" name="PrivacyPolicyContent">{{$PrivacyPolicy->PrivacyPolicyContent}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="">
