                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($Qualification->Active_Status==0)
                                                <a class="btn btn-danger" href="{{url('qualification-active-deactive',[$Qualification->Active_Status,$Qualification->id])}}">Deactive <i class="fa fa-ban" aria-hidden="true"></i></a>
                                            @endif
                                            @if($Qualification->Active_Status==1)
                                                <a class="btn btn-success" href="{{url('qualification-active-deactive',[$Qualification->Active_Status,$Qualification->id])}}">Active <i class="fa fa-check"></i></a>
                                            @endif
                                        </td>
                                        <td>
